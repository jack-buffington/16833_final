...
def ICP06(XY1, XY2):
    ...
    translation, rotationMatrix = actualICP(XY1, XY2)
    ...
    trans, rot = actualICP(XY1, XY2refined)


    #transformMatrix = [rotationMatrix translation'; [0 0 1]] 
    transformMatrix = np.matrix([[rot[0,0], rot[0,1], trans[0,0]],
